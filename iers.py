...
def make_ut1_dat():
    ...
    tai_utc = (
        np.array(leap_sec_values)[
            np.searchsorted(leap_sec, iers_a["MJD"], side="right") - 1
        ]
        * u.s
    )
    print(
    ...
    (A3,2X,I5,6(I7,1X),1X,I2)        2                  6  5           1.E-4"""
        ),
        file=r,
    )
    ...
    return (
        r.getvalue(),
        Time(iers_a[0]["MJD"], format="mjd"),
        Time(iers_a[-1]["MJD"], format="mjd"),
    )

...
TAI to BIPM-updated TT, 2025 version
...
for 2025. It contains forecasted values for 1000 days past the
...
|     |     |
|:--- |:--- |
| File | `T2runtime/clock/tai2tt_bipm2025.clk` |
| Authority | observatory |
| URL in repository | <https://raw.githubusercontent.com/ipta/pulsar-clock-corrections/main/T2runtime/clock/tai2tt_bipm2025.clk> |
| Original download URL | <None> |
| Format | tempo2 |
| Bogus last correction | False |
| Clock file start | 1975-06-26 MJD 42589.0 |
| Clock file end | 2028-09-25 MJD 62039.0 |
...
```
2026-03-06 15:00:01.776 - Initialized
2026-03-06 15:00:01.775 - Updated
2026-03-06 15:00:50.793 - Unchanged
```
[Full log](https://raw.githubusercontent.com/ipta/pulsar-clock-corrections/main/log/T2runtime/clock/tai2tt_bipm2025.clk.log)
...
Leading comments from clock file:
    ...
    #
    # TT(BIPM25) has been established according to the principles described in
    ...
    # until December 2025. Following Recommendation S2 (1996) of the CCDS, a frequency
    # correction for the black-body radiation shift is applied to all frequency standard results.
    #
    # The computation interval of TT(BIPM25) starts on MJD 58479 (27 December 2018). Before
    # that date, TT(BIPM25) is by construction identical to the past realization TT(BIPM24).
    # Then the maximum difference between TT(BIPM25) and TT(BIPM24) is 0.2 ns.
    # The difference between TT(BIPM25) and the formula extending TT(BIPM24) over the year 2025
    # (see the file TTBIPM.2024) is between -6.2 ns and -0.2 ns.
    #
    # Starting MJD 52729, TT(BIPM25) is provided with 0.1 ns resolution, consistent with
    # the resolution of TAI.
    #
    # Until the next realization, users can extend TT(BIPM25) after MJD 61039 as
    # TT(BIPM25) = TAI + 32.184 s + 27670.1 ns - 0.02x(MJD-61039) ns
    #
    #   1st column : MJD at 0 h UTC
    #   2nd   "    : TT(BIPM25) - EAL - 32.184 s, unit is one microsecond
    #   3rd   "    : TT(BIPM25) - TAI - 32.184 s, unit is one microsecond



All clock corrections:

![plot of all clock corrections](tai2tt_bipm2025.clk.png "All corrections")

Recent clock corrections:

![plot of recent clock corrections](tai2tt_bipm2025.clk.short.png "Recent corrections")
